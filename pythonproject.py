...
outputskills += (skills[len(skills)-1] + ". ")
...
outputintrests = " "
for i in range(0 , len(intrests)-1):
     outputintrests += (intrests[i] + ", ")
outputintrests += (intrests[len(intrests)-1] + ". ")
...
pdf = FPDF()
pdf.add_page()
pdf.image('E:\\Akash\\Coding\\PythonProgramming\\face.png',h=25, w=25 , x=14 , y= 2)
pdf.image('E:\\Akash\\Coding\\PythonProgramming\\line.png', 100, 4, 12)
...
pdf.output("E:\\Akash\\Coding\\PythonProgramming\\MyResume.pdf")
